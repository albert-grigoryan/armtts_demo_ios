...
public class ARMTTS {
    var apiUrl = "https://armtts.online:5555/preprocess"
    var rate: Float = 1.0
    ...
    public func speak(string: String) {
        ...
        do {
            ...
            let sampleBuffer = try CMSampleBuffer(dataBuffer: blockBuffer, formatDescription: formatDescription, numSamples: data.count / 4, presentationTimeStamp: sampleBufferRenderSynchronizer.currentTime() + CMTime(seconds: delay, preferredTimescale: CMTimeScale(sampleRate)), packetDescriptions: [])
    ...
    func process(_ text: String) -> [Int32] {
        ...
        let parameters = [
          ...
          ["key": "api_key", "value": token, "type": "text"]] as [[String : Any]]
